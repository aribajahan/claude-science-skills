...
Reusable skills for research-evidence work, built on Anthropic's Claude Science workbench. Each one came out of one real project — a source-verified review of the research on AI and adult cognition — and each is here because it caught a real error or removed a real friction while that review was built.
